    ...
    ui(new Ui::ChooseAddAccountDialog)
{
    ...
    ui->newBtn->setStyleSheet("QPushButton{background-color:#e6e6e6;color:#464646;border:1px solid rgb(239,239,239);border-radius:0px;}"
                                  "QPushButton:hover{background-color:#7dd9df;color:#ffffff;border:0px solid rgb(64,153,255);border-radius:0px;}"
                                  );
    ui->importBtn->setStyleSheet("QPushButton{background-color:#e6e6e6;color:#464646;border:1px solid rgb(239,239,239);border-radius:0px;}"
                                  "QPushButton:hover{background-color:#7dd9df;color:#ffffff;border:0px solid rgb(64,153,255);border-radius:0px;}"
                                  );
}
