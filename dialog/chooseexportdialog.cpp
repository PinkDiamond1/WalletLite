...
//    Goopal::getInstance()->appendCurrentDialogVector(this);
    ...
    ui->upgradeBtn->setStyleSheet("QPushButton{background-color:#ffffff;color:#7dd9df;border:1px solid #7dd9df;border-radius:3px;}"
                                  "QPushButton:hover{background-color:#7dd9df;color:#ffffff;border:0px solid rgb(64,153,255);border-radius:3px;}"
                                  );
    ui->delegateBtn->setStyleSheet("QPushButton{background-color:#ffffff;color:#7dd9df;border:1px solid #7dd9df;border-radius:3px;}"
                                   "QPushButton:hover{background-color:#7dd9df;color:#ffffff;border:0px solid rgb(64,153,255);border-radius:3px;}"
                                   );
    ui->notUpgradeBtn->setStyleSheet("QPushButton{background-color:#ffffff;color:#7dd9df;border:1px solid #7dd9df;border-radius:3px;}"
                                     "QPushButton:hover{background-color:#7dd9df;color:#ffffff;border:0px solid rgb(64,153,255);border-radius:3px;}"
                                     );
}
