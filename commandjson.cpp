...
void CommandJson::addSpeicalPrefix(const QString& prefix) {
	_special_prefix = prefix;
}

void CommandJson::addSepcialPostfix(const QString& postfix) {
...
void CommandJson::setCommand(const QString& command) {
